...
graph = figure( 'FileName', [totAppData{1}.save.saveDir '_temp.fig']);
plot( tof2, sx2, 'ob');
hold on
...
assignin('base','Txtemp',resX.p1 / totAppData{1}.consts.Kb*totAppData{1}.consts.Mrb * 1e6) 
assignin('base','TxEtemp',confX(1) / totAppData{1}.consts.Kb*totAppData{1}.consts.Mrb * 1e6)
assignin('base','Tytemp',resY.p1 / totAppData{1}.consts.Kb*totAppData{1}.consts.Mrb * 1e6)
assignin('base','TyEtemp',confY(1) / totAppData{1}.consts.Kb*totAppData{1}.consts.Mrb * 1e6)
